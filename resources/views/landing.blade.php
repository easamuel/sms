...
<body>
                    ...
                    <div class="demo-slide" data-slide="6">
                        <div class="demo-content">
                            ...
                            <div class="demo-text">
                                ...
                                <div class="demo-cta">
                                    <a href="{{ route('login') }}" class="demo-btn">
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <div class="footer-section">
                <h5>Support</h5>
                <a href="{{ route('contact') }}">Get Help</a>
        ...
        <div class="footer-bottom">
            <p>&copy; {{ date('Y') }} ES-SCHOOLS by <a href="https://extremesolutions.com.ng" target="_blank" style="color: var(--green); text-decoration: none; font-weight: 600;">ExtremeSolutions</a>. All rights reserved.</p>
