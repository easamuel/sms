        ...
        <div class="login-container">
            ...
            <div class="login-right">
                ...
                <form method="POST" action="{{ route('login.submit') }}" class="login-form" id="loginForm">
                    ...
                    <input type="hidden" name="role_fallback" id="role-fallback" value="{{ old('role', 'admin') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="role-selection">
                            <label for="role-admin" class="role-label">
                                <input type="radio" name="role" value="admin" {{ old('role', 'admin') === 'admin' ? 'checked' : '' }} required id="role-admin">
                                <span>Admin</span>
                            </label>
                            <label for="role-teacher" class="role-label">
                                <input type="radio" name="role" value="teacher" {{ old('role') === 'teacher' ? 'checked' : '' }} required id="role-teacher">
                                <span>Teacher</span>
                            </label>
                            <label for="role-student" class="role-label">
                                <input type="radio" name="role" value="student" {{ old('role') === 'student' ? 'checked' : '' }} required id="role-student">
                                <span>Student</span>
                            </label>
                            <label for="role-parent" class="role-label">
                                <input type="radio" name="role" value="parent" {{ old('role') === 'parent' ? 'checked' : '' }} required id="role-parent">
                                <span>Parent</span>
                            </label>
                        </div>
                        @error('role')
